    ...
    <div>
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%" :height="height">
        <el-table-column label="序号" type="index" width="50" align="center"></el-table-column>
          ...
          <el-table-column label="白细胞值" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.leu }}</template>
          </el-table-column>
          <el-table-column label="亚硝酸盐值" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.nit }}</template>
          </el-table-column>
          <el-table-column label="尿胆原值" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.ubg }}</template>
          </el-table-column>
          <el-table-column label="蛋白质值" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.pro }}</template>
          </el-table-column>
          <el-table-column label="酸碱度值" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.ph }}</template>
          </el-table-column>
          <el-table-column label="红细胞值" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.bld }}</template>
          </el-table-column>
          <el-table-column label="比重" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.sg }}</template>
          </el-table-column>
          <el-table-column label="酮体值" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.ket }}</template>
          </el-table-column>
          <el-table-column label="胆红素值" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.bil }}</template>
          </el-table-column>
          <el-table-column label="葡萄糖值" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.glu }}</template>
          </el-table-column>
          <el-table-column label="维生素值" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.vc }}</template>
          </el-table-column>
    ...
    <el-dialog :title="(labelType=='add'?'新增':'编辑')" :visible.sync="showDialog" width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="10">
            ...
            <el-col :span="12">
              <el-form-item label="测量条件：" prop="siteName">
                <el-input v-model="form.conditions" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="白细胞值：" prop="siteName">
                <el-input v-model="form.leu" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="亚硝酸盐值：" prop="siteName">
                <el-input v-model="form.nit" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="尿胆原值：" prop="siteName">
                <el-input v-model="form.ubg" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="蛋白质值：" prop="siteName">
                <el-input v-model="form.pro" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="酸碱度值：" prop="siteName">
                <el-input v-model="form.ph" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="红细胞值：" prop="siteName">
                <el-input v-model="form.bld" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="比重：" prop="siteName">
                <el-input v-model="form.sg" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="酮体值：" prop="siteName">
                <el-input v-model="form.ket" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="胆红素值：" prop="siteName">
                <el-input v-model="form.bil" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="葡萄糖值：" prop="siteName">
                <el-input v-model="form.glu" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="维生素值：" prop="siteName">
                <el-input v-model="form.vc" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="分析结果：" prop="siteName">
                <el-input v-model="form.analysisResult" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    getList () {
	  var that = this;
    that.loading = true
	  that.$http.post("/healthUrinalysisRecords/list", that.queryInfo).then(function (response) {
    ...
    handleSave () {
	    var that = this;
	  that.$http.post("/healthUrinalysisRecords/save", that.form).then(function (response) {
		  if (response.data.code == 200) {
			  that.$notify.success({
				title: "提示",
				message: "保存成功",
...
//    },
    ...
    async handleDelte(id) {
      ...
      if (confirmResult === "confirm") {
           var that = this;
        that.$http.post("/healthUrinalysisRecords/delete" ,{"id":id}).then(function (response) {
			if(response.data.code == 200){
			 that.$notify.success({
				title: "提示",
				message: "删除成功",
