    ...
    <div>
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%" :height="height">
        <el-table-column label="序号" type="index" width="50" align="center"></el-table-column>
          ...
          <el-table-column label="供应商类型" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.supplierType }}</template>
          </el-table-column>
          ...
          <el-table-column label="证件号码" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.documentCode }}</template>
          </el-table-column>
          <el-table-column label="税号" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.taxNumber }}</template>
          </el-table-column>
          <el-table-column label="开户名" align="center" show-overflow-tooltip>
          ...
          <el-table-column label="营业执照编号" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.businessNumber }}</template>
          </el-table-column>
          <el-table-column label="有效期" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.periodValidity }}</template>
          </el-table-column>
          <el-table-column label="经营范围" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.businessScope }}</template>
          </el-table-column>
          <el-table-column label="供应商地址" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.supplierAddress }}</template>
          </el-table-column>
          <el-table-column label="营业执照路径" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.businessImgPath }}</template>
          </el-table-column>
    ...
    <el-dialog :title="(labelType=='add'?'新增':'编辑')" :visible.sync="showDialog" width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="10">
            ...
            <el-col :span="12">
              <el-form-item label="供应商名称：" prop="siteName">
                <el-input v-model="form.supplierName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="供应商类型：" prop="siteName">
                <el-input v-model="form.supplierType" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="联系人：" prop="siteName">
                <el-input v-model="form.linkMan" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="法人姓名：" prop="siteName">
                <el-input v-model="form.legalPerson" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="证件类型：" prop="siteName">
                <el-input v-model="form.documentType" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="证件号码：" prop="siteName">
                <el-input v-model="form.documentCode" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="税号：" prop="siteName">
                <el-input v-model="form.taxNumber" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="开户名：" prop="siteName">
                <el-input v-model="form.accountName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="开户银行：" prop="siteName">
                <el-input v-model="form.bankName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="银行账号：" prop="siteName">
                <el-input v-model="form.bankCode" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="营业执照编号：" prop="siteName">
                <el-input v-model="form.businessNumber" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="有效期：" prop="siteName">
                <el-input v-model="form.periodValidity" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="经营范围：" prop="siteName">
                <el-input v-model="form.businessScope" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="供应商地址：" prop="siteName">
                <el-input v-model="form.supplierAddress" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="营业执照路径：" prop="siteName">
                <el-input v-model="form.businessImgPath" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    getList () {
	  var that = this;
    that.loading = true
	  that.$http.post("/insLogisticsSupplierInfo/list", that.queryInfo).then(function (response) {
    ...
    handleSave () {
	    var that = this;
	  that.$http.post("/insLogisticsSupplierInfo/save", that.form).then(function (response) {
		  if (response.data.code == 200) {
			  that.$notify.success({
				title: "提示",
				message: "保存成功",
...
//    },
    ...
    async handleDelte(id) {
      ...
      if (confirmResult === "confirm") {
           var that = this;
        that.$http.post("/insLogisticsSupplierInfo/delete" ,{"id":id}).then(function (response) {
			if(response.data.code == 200){
			 that.$notify.success({
				title: "提示",
				message: "删除成功",
