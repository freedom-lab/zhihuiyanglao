    ...
    <div>
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%" :height="height">
        <el-table-column label="序号" type="index" width="50" align="center"></el-table-column>
          ...
          <el-table-column label="出库日期" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.outboundDate }}</template>
          </el-table-column>
          <el-table-column label="出库编号" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.outboundCode }}</template>
          </el-table-column>
          <el-table-column label="出库类型" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.ckType }}</template>
          </el-table-column>
        
          <el-table-column label="仓库名称" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.warehouseName }}</template>
          </el-table-column>
          <el-table-column label="领用类型" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.neckType }}</template>
          </el-table-column>
          <el-table-column label="部门名称" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.neckDepartment }}</template>
          </el-table-column>
      
          <el-table-column label="领用人姓名" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.neckName }}</template>
          </el-table-column>
          <el-table-column label="出库金额(元)" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.outboundAmount }}</template>
          </el-table-column>
          <el-table-column label="出库状态" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.ckState }}</template>
          </el-table-column>
          ...
          <el-table-column label="主回收状态" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.recoveryStatus }}</template>
          </el-table-column>
          <el-table-column label="回收时间" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.recoveryTime }}</template>
          </el-table-column>
          <el-table-column label="备注" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.remark }}</template>
          </el-table-column>
        
          <el-table-column label="录单人姓名" align="center" show-overflow-tooltip>
          ...
          <el-table-column label="录单时间" align="center" show-overflow-tooltip>
...
<!-- 
            ...
            <el-col :span="12">
              <el-form-item label="出库日期：" prop="siteName">
                <el-input v-model="form.outboundDate" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="出库编号：" prop="siteName">
                <el-input v-model="form.outboundCode" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="出库类型：" prop="siteName">
                <el-input v-model="form.ckType" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="12">
              <el-form-item label="领用类型：" prop="siteName">
                <el-input v-model="form.neckType" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="部门名称：" prop="siteName">
                <el-input v-model="form.neckDepartment" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
           
            <el-col :span="12">
              <el-form-item label="领用人姓名：" prop="siteName">
                <el-input v-model="form.neckName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="出库金额(元)：" prop="siteName">
                <el-input v-model="form.outboundAmount" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="出库状态：" prop="siteName">
                <el-input v-model="form.ckState" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="主回收状态：" prop="siteName">
                <el-input v-model="form.recoveryStatus" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="回收时间：" prop="siteName">
                <el-input v-model="form.recoveryTime" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="录单人姓名：" prop="siteName">
                <el-input v-model="form.createName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            
            <el-col :span="12">
              <el-form-item label="录单时间：" prop="siteName">
...
export default {
  ...
  methods: {
    ...
    getList () {
	  var that = this;
    that.loading = true
	  that.$http.post("/insLogisticsOutboundInfo/list", that.queryInfo).then(function (response) {
    ...
    handleSave () {
	    var that = this;
	  that.$http.post("/insLogisticsOutboundInfo/save", that.form).then(function (response) {
		  if (response.data.code == 200) {
			  that.$notify.success({
				title: "提示",
				message: "保存成功",
...
//    },
    ...
    async handleDelte(id) {
      ...
      if (confirmResult === "confirm") {
           var that = this;
        that.$http.post("/insLogisticsOutboundInfo/delete" ,{"id":id}).then(function (response) {
			if(response.data.code == 200){
			 that.$notify.success({
				title: "提示",
				message: "删除成功",
