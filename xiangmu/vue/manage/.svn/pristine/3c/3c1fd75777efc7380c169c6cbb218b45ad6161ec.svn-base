    ...
    <div>
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%" :height="height">
        <el-table-column label="序号" type="index" width="50" align="center"></el-table-column>
          ...
          <el-table-column label="血压-高压" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.heightPressure }}</template>
          </el-table-column>
          <el-table-column label="血压-低压" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.lowPressure }}</template>
          </el-table-column>
          <el-table-column label="脉搏" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.pulse }}</template>
          </el-table-column>
          <el-table-column label="动脉脉搏波速率指数" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.aVI }}</template>
          </el-table-column>
          <el-table-column label="参考状态" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.aVIRefer }}</template>
          </el-table-column>
          <el-table-column label="动脉压力容积指数" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.aPI }}</template>
          </el-table-column>
          <el-table-column label="参考状态" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.aPIRefer }}</template>
          </el-table-column>
          <el-table-column label="CSBP" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.cSBP }}</template>
          </el-table-column>
          <el-table-column label="CAPP" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.cAPP }}</template>
          </el-table-column>
          <el-table-column label="测量时间" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.addTime }}</template>
          </el-table-column>
          <el-table-column label="健康建议" align="center" show-overflow-tooltip>
    ...
    <el-dialog :title="(labelType=='add'?'新增':'编辑')" :visible.sync="showDialog" width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="10">
            ...
            <el-col :span="12">
              <el-form-item label="血压-高压：" prop="siteName">
                <el-input v-model="form.heightPressure" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="血压-低压：" prop="siteName">
                <el-input v-model="form.lowPressure" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="脉搏：" prop="siteName">
                <el-input v-model="form.pulse" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="动脉脉搏波速率指数：" prop="siteName">
                <el-input v-model="form.aVI" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="参考状态：" prop="siteName">
                <el-input v-model="form.aVIRefer" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="动脉压力容积指数：" prop="siteName">
                <el-input v-model="form.aPI" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="参考状态：" prop="siteName">
                <el-input v-model="form.aPIRefer" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="CSBP：" prop="siteName">
                <el-input v-model="form.cSBP" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="CAPP：" prop="siteName">
                <el-input v-model="form.cAPP" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="测量时间：" prop="siteName">
                <el-input v-model="form.addTime" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="健康建议：" prop="siteName">
                <el-input v-model="form.tip" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    getList () {
	  var that = this;
    that.loading = true
	  that.$http.post("/healthArteriosclerosis/list", that.queryInfo).then(function (response) {
    ...
    handleSave () {
	    var that = this;
	  that.$http.post("/healthArteriosclerosis/save", that.form).then(function (response) {
		  if (response.data.code == 200) {
			  that.$notify.success({
				title: "提示",
				message: "保存成功",
...
//    },
    ...
    async handleDelte(id) {
      ...
      if (confirmResult === "confirm") {
           var that = this;
        that.$http.post("/healthArteriosclerosis/delete" ,{"id":id}).then(function (response) {
			if(response.data.code == 200){
			 that.$notify.success({
				title: "提示",
				message: "删除成功",
