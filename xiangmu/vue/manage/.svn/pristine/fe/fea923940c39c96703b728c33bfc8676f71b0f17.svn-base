...
<script>
import itemTable1 from './children/drawerTabInfo17_table1.vue';
import itemTable2 from './children/drawerTabInfo17_table2.vue';
import itemTable3 from './children/drawerTabInfo17_table3.vue';
export default {
  props: {
    elderForm: {
      type: Object,
