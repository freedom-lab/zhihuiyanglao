      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="10">
           ...
           -->
            ...
            <el-col :span="12">
              <el-form-item label="得分：" prop="siteName">
                <el-input v-model="form.scoreNumber" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    handleSave () {
	    var that = this;
	  that.$http.post("/insTrainStaffRecord/save", that.form).then(function (response) {
		  if (response.data.code == 200) {
			  that.$notify.success({
				title: "提示",
				message: "保存成功",
