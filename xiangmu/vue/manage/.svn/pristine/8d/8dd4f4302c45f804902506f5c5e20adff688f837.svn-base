    ...
    <div>
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%" :height="height">
        ...
        <el-table-column label="老人姓名" align="center" show-overflow-tooltip>
          ...
          <el-table-column label="服务时间" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.serviceTime }}</template>
          </el-table-column>
          <el-table-column label="自选服务大类id" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.typeId }}</template>
          </el-table-column>
          <el-table-column label="自选服务大类名称" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.typeName }}</template>
          </el-table-column>
          <el-table-column label="自选服务项目id" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.itemId }}</template>
          </el-table-column>
          <el-table-column label="自选服务项目名称" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.itemName }}</template>
          </el-table-column>
          <el-table-column label="服务价格" align="center" show-overflow-tooltip>
          ...
          <el-table-column label="服务总价" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.totalAmount }}</template>
          </el-table-column>
          <el-table-column label="服务状态(1未开始" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.serviceState }}</template>
          </el-table-column>
          <el-table-column label="服务开始时间" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.serviceStartTime }}</template>
          </el-table-column>
          <el-table-column label="服务结束时间" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.serviceEndTime }}</template>
          </el-table-column>
          <el-table-column label="支付状态(1未支付" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.payState }}</template>
          </el-table-column>
          <el-table-column label="支付方式(1现金" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.payMethod }}</template>
          </el-table-column>
       
          <el-table-column label="护理人员名称" align="center" show-overflow-tooltip>
    ...
    <el-dialog :title="(labelType=='add'?'新增':'编辑')" :visible.sync="showDialog" width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="10">
            ...
            <el-col :span="12">
              <el-form-item label="服务时间：" prop="siteName">
                <el-input v-model="form.serviceTime" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="自选服务大类id：" prop="siteName">
                <el-input v-model="form.typeId" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="自选服务大类名称：" prop="siteName">
                <el-input v-model="form.typeName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="自选服务项目id：" prop="siteName">
                <el-input v-model="form.itemId" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="自选服务项目名称：" prop="siteName">
                <el-input v-model="form.itemName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="服务价格：" prop="siteName">
                <el-input v-model="form.itemPrice" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="购买数量：" prop="siteName">
                <el-input v-model="form.buyNumber" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="服务总价：" prop="siteName">
                <el-input v-model="form.totalAmount" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="服务状态(1未开始：" prop="siteName">
                <el-input v-model="form.serviceState" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="服务开始时间：" prop="siteName">
                <el-input v-model="form.serviceStartTime" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="服务结束时间：" prop="siteName">
                <el-input v-model="form.serviceEndTime" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="支付状态(1未支付：" prop="siteName">
                <el-input v-model="form.payState" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="支付方式(1现金：" prop="siteName">
                <el-input v-model="form.payMethod" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="护理人员id：" prop="siteName">
                <el-input v-model="form.staffId" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="护理人员名称：" prop="siteName">
            ...
            <el-col :span="12">
              <el-form-item label="服务图片路径(多个逗号分隔)：" prop="siteName">
            ...
            <el-col :span="12">
              <el-form-item label="下次服务日期：" prop="siteName">
                <el-input v-model="form.nextDate" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="服务时长（分钟）：" prop="siteName">
                <el-input v-model="form.serviceDuration" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    getList () {
	  var that = this;
    that.loading = true
	  that.$http.post("/insNursingServiceOrder/list", that.queryInfo).then(function (response) {
    ...
    handleSave () {
	    var that = this;
	  that.$http.post("/insNursingServiceOrder/save", that.form).then(function (response) {
		  if (response.data.code == 200) {
			  that.$notify.success({
				title: "提示",
				message: "保存成功",
...
//    },
    ...
    async handleDelte(id) {
      ...
      if (confirmResult === "confirm") {
           var that = this;
        that.$http.post("/insNursingServiceOrder/delete" ,{"id":id}).then(function (response) {
			if(response.data.code == 200){
			 that.$notify.success({
				title: "提示",
				message: "删除成功",
