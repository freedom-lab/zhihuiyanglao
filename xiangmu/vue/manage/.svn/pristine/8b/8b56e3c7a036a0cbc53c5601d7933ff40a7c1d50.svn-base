  ...
  <div style="padding:16px">
    ...
    <div ref="search_d">
      <el-row type="flex" class="row-bg" justify="space-around">
        <el-col :span="15">
          <span style="font-size:18px;font-weight:bold">院长审核</span>
        </el-col>
        <el-col :span="10">
    ...
    <div class="table-box">
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%"
        ...
        <el-table-column label="入住状态" align="center" min-width="90" show-overflow-tooltip>
          <template slot-scope="scope">
            {{ scope.row.checkState === 1 ? '未住' : scope.row.checkState === 2 ? '试住' : scope.row.checkState ===
              3 ? '入住' : scope.row.checkState === 4 ? '退住' : '-' }}
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="160" align="center" fixed="right">
          <template slot-scope="scope">
            ...
            <el-button type="text" @click="openAudit(scope.row)" size="small" style="padding:0;color:#409EFF;margin-left:8px">审批</el-button>
            <el-popconfirm title="确定删除吗？" @confirm="handleDelte(scope.row.id)">
              <el-button slot="reference" type="text" style="padding: 0;margin-left: 8px;color: red;">删除</el-button>
            </el-popconfirm>
          </template>
        </el-table-column>
      </el-table>
            ...
            <el-row :gutter="10">
              ...
              <el-col :span="12">
                <el-form-item label="申请日期" prop="applyDate">
                  <el-date-picker v-model="form.applyDate" type="date" placeholder="请选择申请日期" style="width:100%"></el-date-picker>
                </el-form-item>
              </el-col>
              ...
              <el-col :span="12">
                <el-form-item label="计划入住日期" prop="planDate">
                  <el-date-picker v-model="form.planDate" type="date" placeholder="请选择计划入住日期" style="width:100%"></el-date-picker>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="实际入住日期" prop="checkDate">
                  <el-date-picker v-model="form.checkDate" type="date" placeholder="请选择实际入住日期" style="width:100%"></el-date-picker>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="试住结束日期" prop="tryingEndDate">
                  <el-date-picker v-model="form.tryingEndDate" type="date" placeholder="请选择试住结束日期" style="width:100%"></el-date-picker>
                </el-form-item>
              </el-col>
              <el-col :span="12">
              ...
              <el-col :span="12">
                <el-form-item label="退住时间" prop="retreatTime">
                  <el-date-picker v-model="form.retreatTime" type="date" placeholder="请选择退住时间" style="width:100%"></el-date-picker>
                </el-form-item>
              </el-col>
              ...
              <el-col :span="12">
                <el-form-item label="是否包房" prop="isRoom">
                  <el-select v-model="form.isRoom" placeholder="请选择" style="width:100%">
              ...
              <el-col :span="12">
                <el-form-item label="是否户主" prop="isHousehold">
                  <el-select v-model="form.isHousehold" placeholder="请选择" style="width:100%">
              ...
              <el-col :span="12">
                <el-form-item label="户主是否在住" prop="householdCheckState">
                  <el-select v-model="form.householdCheckState" placeholder="请选择" style="width:100%">
                    <el-option label="是" :value="1"></el-option>
                    <el-option label="否" :value="2"></el-option>
                  </el-select>
                </el-form-item>
              ...
              <el-col :span="12">
                <el-form-item label="是否翻身护理" prop="turnOverState">
                  <el-select v-model="form.turnOverState" placeholder="请选择" style="width:100%">
                    <el-option label="否" :value="1"></el-option>
                    <el-option label="是" :value="2"></el-option>
                  </el-select>
                </el-form-item>
              ...
              <el-col :span="12">
                <el-form-item label="身份类别" prop="elderCategory">
                  <el-input v-model="form.elderCategory" placeholder="请输入身份类别"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
              ...
              <el-col :span="12">
                <el-form-item label="视频打卡" prop="signIsVideo">
                  <el-select v-model="form.signIsVideo" placeholder="请选择" style="width:100%">
    ...
    <!-- 审批弹窗 -->
    <el-dialog title="审批操作" :visible.sync="showAuditDialog" width="500px">
      <el-form ref="auditFormRef" :model="auditForm" label-width="100px">
        <el-form-item label="审批意见" prop="auditMemo">
          <el-input v-model="auditForm.auditMemo" type="textarea" rows="4" placeholder="请输入审批意见"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button danger style="margin-left: 10px" @click="submitAudit(3)">拒绝</el-button>
...
export default {
  ...
  methods: {
    ...
    // 提交审批接口
    submitAudit(auditState) {
      this.$refs.auditFormRef.validate((valid) => {
        if (!valid) return
        const that = this
        that.auditForm.auditState = auditState;
        that.$http.post("/insElderCheckInfo/checkPass", that.auditForm).then(res => {
          if (res.data.code === 200) {
            that.$notify.success({ title: '提示', message: '审批提交成功' })
