    ...
    <div>
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%" :height="height">
        <el-table-column label="序号" type="index" width="50" align="center"></el-table-column>
          ...
          <el-table-column label="保质期(月)" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.periodNum }}</template>
          </el-table-column>
          <el-table-column label="是否允许售卖" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.isSales }}</template>
          </el-table-column>
          <el-table-column label="销售价格(元)" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.sellingPrice }}</template>
          </el-table-column>
          <el-table-column label="预警库存" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.earlyStock }}</template>
          </el-table-column>
          <el-table-column label="物品主图路径" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.iconPath }}</template>
          </el-table-column>
          <el-table-column label="简要描述,卖点等" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.briefContent }}</template>
          </el-table-column>
          <el-table-column label="详细描述" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.description }}</template>
          </el-table-column>
          <el-table-column label="浏览次数" align="center" show-overflow-tooltip>
          ...
          <el-table-column label="物品状态" align="center" show-overflow-tooltip>
    ...
    <el-dialog :title="(labelType=='add'?'新增':'编辑')" :visible.sync="showDialog" width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="10">
            ...
            <el-col :span="12">
              <el-form-item label="保质期(月)：" prop="siteName">
                <el-input v-model="form.periodNum" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="是否允许售卖：" prop="siteName">
                <el-input v-model="form.isSales" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="预警库存：" prop="siteName">
                <el-input v-model="form.earlyStock" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="物品主图路径：" prop="siteName">
                <el-input v-model="form.iconPath" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="简要描述,卖点等：" prop="siteName">
                <el-input v-model="form.briefContent" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="详细描述：" prop="siteName">
                <el-input v-model="form.description" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="浏览次数：" prop="siteName">
                <el-input v-model="form.clickNum" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="物品状态：" prop="siteName">
...
export default {
  ...
  methods: {
    ...
    getList () {
	  var that = this;
    that.loading = true
	  that.$http.post("/insLogisticsGoodsInfo/list", that.queryInfo).then(function (response) {
    ...
    handleSave () {
	    var that = this;
	  that.$http.post("/insLogisticsGoodsInfo/save", that.form).then(function (response) {
		  if (response.data.code == 200) {
			  that.$notify.success({
				title: "提示",
				message: "保存成功",
...
//    },
    ...
    async handleDelte(id) {
      ...
      if (confirmResult === "confirm") {
           var that = this;
        that.$http.post("/insLogisticsGoodsInfo/delete" ,{"id":id}).then(function (response) {
			if(response.data.code == 200){
			 that.$notify.success({
				title: "提示",
				message: "删除成功",
