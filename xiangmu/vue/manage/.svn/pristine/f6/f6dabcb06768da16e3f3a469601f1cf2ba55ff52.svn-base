    ...
    <div>
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%" :height="height">
        ...
        <el-table-column label="老人姓名" align="center" show-overflow-tooltip>
          ...
          <el-table-column label="事件类别" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.eventType }}</template>
          </el-table-column>
          <el-table-column label="事件预案内容" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.planMemo }}</template>
          </el-table-column>
          <el-table-column label="发生时间" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.eventTime }}</template>
          </el-table-column>
          <el-table-column label="发生地点" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.eventPlace }}</template>
          </el-table-column>
          <el-table-column label="事件经过" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.eventProcess }}</template>
          </el-table-column>
          <el-table-column label="严重程度" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.severityType }}</template>
          </el-table-column>
    ...
    <el-dialog :title="(labelType=='add'?'新增':'编辑')" :visible.sync="showDialog" width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="10">
            ...
            <el-col :span="12">
              <el-form-item label="事件类别：" prop="siteName">
                <el-input v-model="form.eventType" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="事件预案内容：" prop="siteName">
                <el-input v-model="form.planMemo" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="发生时间：" prop="siteName">
                <el-input v-model="form.eventTime" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="发生地点：" prop="siteName">
                <el-input v-model="form.eventPlace" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="事件经过：" prop="siteName">
                <el-input v-model="form.eventProcess" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="严重程度：" prop="siteName">
                <el-input v-model="form.severityType" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="处理人员名称：" prop="siteName">
            ...
            <el-col :span="12">
              <el-form-item label="处理结果：" prop="siteName">
                <el-input v-model="form.handleResults" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="最终讨论意见：" prop="siteName">
                <el-input v-model="form.discussionOpinions" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="附件路径：" prop="siteName">
                <el-input v-model="form.eventImgPath" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    getList () {
	  var that = this;
    that.loading = true
	  that.$http.post("/insSuddenEventInfo/list", that.queryInfo).then(function (response) {
    ...
    handleSave () {
	    var that = this;
	  that.$http.post("/insSuddenEventInfo/save", that.form).then(function (response) {
		  if (response.data.code == 200) {
			  that.$notify.success({
				title: "提示",
				message: "保存成功",
...
//    },
    ...
    async handleDelte(id) {
      ...
      if (confirmResult === "confirm") {
           var that = this;
        that.$http.post("/insSuddenEventInfo/delete" ,{"id":id}).then(function (response) {
			if(response.data.code == 200){
			 that.$notify.success({
				title: "提示",
				message: "删除成功",
