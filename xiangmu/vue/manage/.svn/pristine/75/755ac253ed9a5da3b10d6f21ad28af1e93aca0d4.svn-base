  ...
  <div class="tab-box">
    ...
    <div class="table-box">
      ...
      >
        ...
        <el-table-column label="订单编号" align="center" min-width="120" fixed="left">
          <template slot-scope="scope">{{ scope.row.orderCode }}</template>
        </el-table-column>
        <el-table-column label="服务日期" align="center" min-width="120">
          <template slot-scope="scope">{{ scope.row.serviceTime }}</template>
        </el-table-column>
        <el-table-column label="服务大类" align="center" min-width="120">
          <template slot-scope="scope">{{ scope.row.typeName }}</template>
        </el-table-column>
        <el-table-column label="服务项目" align="center" min-width="120">
          <template slot-scope="scope">{{ scope.row.itemName }}</template>
        </el-table-column>
        <el-table-column label="项目单价（元）" align="center" min-width="80">
        ...
        <el-table-column label="合计金额（元）" align="center" min-width="120">
        ...
        <el-table-column label="服务状态" align="center" min-width="80">
          <template slot-scope="scope">{{ scope.row.serviceState | serviceStateFormat }}</template>
        </el-table-column>
  ...
  methods: {
    ...
    handleSave() {
      ...
      that.$refs.form.validate((valid) => {
        ...
        that.$http.post("/insNursingServiceOrder/save", that.form).then( (response)=> {
          if (response.data.code == 200) {
            that.$notify.success({
              title: "提示",
              message: "保存成功",
