    ...
    <div>
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%" :height="height">
        <el-table-column label="序号" type="index" width="50" align="center"></el-table-column>
          ...
          <el-table-column label="巡房计划名称" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.planName }}</template>
          </el-table-column>
          <el-table-column label="巡房日期" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.patrolRoomDate }}</template>
          </el-table-column>
          <el-table-column label="巡房时段(hh:mm)" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.timeSlot }}</template>
          </el-table-column>
          <el-table-column label="巡房内容" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.patrolContent }}</template>
          </el-table-column>
          ...
          <el-table-column label="房间信息" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.roomInfo }}</template>
          </el-table-column>
          <el-table-column label="巡房状态(1未完成" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.patrolState }}</template>
          </el-table-column>
        
          <el-table-column label="巡房人姓名" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.staffName }}</template>
          </el-table-column>
        
          <el-table-column label="护理组名称" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.nursingGroupName }}</template>
          </el-table-column>
          <el-table-column label="完成时间" align="center" show-overflow-tooltip>
    ...
    <el-dialog :title="(labelType=='add'?'新增':'编辑')" :visible.sync="showDialog" width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="10">
            ...
            <el-col :span="12">
              <el-form-item label="巡房计划主键id：" prop="siteName">
                <el-input v-model="form.planId" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="巡房计划名称：" prop="siteName">
                <el-input v-model="form.planName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="巡房日期：" prop="siteName">
                <el-input v-model="form.patrolRoomDate" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="巡房时段(hh:mm)：" prop="siteName">
                <el-input v-model="form.timeSlot" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="巡房内容：" prop="siteName">
                <el-input v-model="form.patrolContent" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="楼栋id：" prop="siteName">
                <el-input v-model="form.buildingId" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="楼层id：" prop="siteName">
                <el-input v-model="form.floorId" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="房间id：" prop="siteName">
                <el-input v-model="form.roomId" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="房间信息：" prop="siteName">
                <el-input v-model="form.roomInfo" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="巡房状态(1未完成：" prop="siteName">
                <el-input v-model="form.patrolState" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="巡房人id：" prop="siteName">
                <el-input v-model="form.staffId" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="巡房人姓名：" prop="siteName">
                <el-input v-model="form.staffName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="护理组id：" prop="siteName">
                <el-input v-model="form.nursingGroupId" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="护理组名称：" prop="siteName">
                <el-input v-model="form.nursingGroupName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="完成时间：" prop="siteName">
                <el-input v-model="form.completeTime" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="巡房说明：" prop="siteName">
                <el-input v-model="form.patrolIllustrate" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="巡房图片(多个逗号分隔)：" prop="siteName">
            ...
            <el-col :span="12">
              <el-form-item label="巡房类型(1app巡房：" prop="siteName">
                <el-input v-model="form.patrolType" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
        </el-row>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    getList () {
	  var that = this;
    that.loading = true
	  that.$http.post("/insNursingRoomExecutionRecord/list", that.queryInfo).then(function (response) {
    ...
    handleSave () {
	    var that = this;
	  that.$http.post("/insNursingRoomExecutionRecord/save", that.form).then(function (response) {
		  if (response.data.code == 200) {
			  that.$notify.success({
				title: "提示",
				message: "保存成功",
...
//    },
    ...
    async handleDelte(id) {
      ...
      if (confirmResult === "confirm") {
           var that = this;
        that.$http.post("/insNursingRoomExecutionRecord/delete" ,{"id":id}).then(function (response) {
			if(response.data.code == 200){
			 that.$notify.success({
				title: "提示",
				message: "删除成功",
