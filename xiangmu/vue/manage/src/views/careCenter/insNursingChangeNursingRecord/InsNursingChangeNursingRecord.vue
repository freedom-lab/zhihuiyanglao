    ...
    <div>
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%" :height="height">
        <el-table-column label="序号" type="index" width="50" align="center"></el-table-column>
          ...
          <el-table-column label="变更执行日期" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.executeDate }}</template>
          </el-table-column>
         
          <el-table-column label="原护理等级名称" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.oldNursingLevelName }}</template>
          </el-table-column>
         
          <el-table-column label="新护理等级名称" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.newNursingLevelName }}</template>
          </el-table-column>
    ...
    <el-dialog :title="(labelType=='add'?'新增':'编辑')" :visible.sync="showDialog" width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="10">
            ...
            <el-col :span="12">
              <el-form-item label="执行状态(1待变更：" prop="siteName">
                <el-input v-model="form.changeState" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="申请时间：" prop="siteName">
                <el-input v-model="form.applyTime" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="变更执行日期：" prop="siteName">
                <el-input v-model="form.executeDate" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="原护理等级id：" prop="siteName">
                <el-input v-model="form.oldNursingLevelId" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="原护理等级名称：" prop="siteName">
                <el-input v-model="form.oldNursingLevelName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="原护理费价格(元)：" prop="siteName">
                <el-input v-model="form.oldNursingPrice" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="新护理等级id：" prop="siteName">
                <el-input v-model="form.newNursingLevelId" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="新护理等级名称：" prop="siteName">
                <el-input v-model="form.newNursingLevelName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="新护理费价格(元)：" prop="siteName">
                <el-input v-model="form.newNursingPrice" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="变更依据(图片路径)：" prop="siteName">
                <el-input v-model="form.accordingPath" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="变更依据说明：" prop="siteName">
                <el-input v-model="form.accordingDescribe" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="老人费用标准id：" prop="siteName">
                <el-input v-model="form.standardId" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="是否已核算差额(1未核算：" prop="siteName">
                <el-input v-model="form.calculateState" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="结算状态(1未结算：" prop="siteName">
                <el-input v-model="form.settlementState" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="缴费账单主键id：" prop="siteName">
                <el-input v-model="form.billId" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="审批状态(1未审批：" prop="siteName">
                <el-input v-model="form.auditState" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="审批人主键id：" prop="siteName">
                <el-input v-model="form.auditId" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="审批人姓名：" prop="siteName">
                <el-input v-model="form.auditName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="审批时间：" prop="siteName">
                <el-input v-model="form.auditTime" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="审批意见：" prop="siteName">
...
export default {
  ...
  methods: {
    ...
    getList () {
	  var that = this;
    that.loading = true
	  that.$http.post("/insNursingChangeNursingRecord/list", that.queryInfo).then(function (response) {
    ...
    handleSave () {
	    var that = this;
	  that.$http.post("/insNursingChangeNursingRecord/save", that.form).then(function (response) {
		  if (response.data.code == 200) {
			  that.$notify.success({
				title: "提示",
				message: "保存成功",
...
//    },
    ...
    async handleDelte(id) {
      ...
      if (confirmResult === "confirm") {
           var that = this;
        that.$http.post("/insNursingChangeNursingRecord/delete" ,{"id":id}).then(function (response) {
			if(response.data.code == 200){
			 that.$notify.success({
				title: "提示",
				message: "删除成功",
