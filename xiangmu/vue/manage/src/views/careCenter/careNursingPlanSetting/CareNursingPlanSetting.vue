    ...
    <div>
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%" :height="height">
        <el-table-column label="序号" type="index" width="50" align="center"></el-table-column>
          ...
          <el-table-column label="照护等级名称" align="center" show-overflow-tooltip>
          ...
          <el-table-column label="项目频率" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.itemFrequency }}</template>
          </el-table-column>
          ...
          <el-table-column label="结束时间(hh:mm)" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.endTime }}</template>
          </el-table-column>
          <el-table-column label="星期几(频率每周)" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.weekNum }}</template>
          </el-table-column>
          <el-table-column label="几号(频率每月)" align="center" show-overflow-tooltip>
    ...
    <el-dialog :title="(labelType=='add'?'新增':'编辑')" :visible.sync="showDialog" width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="10">
            ...
            <el-col :span="12">
              <el-form-item label="照护等级id：" prop="siteName">
                <el-input v-model="form.nursingLevelId" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="照护等级名称：" prop="siteName">
                <el-input v-model="form.nursingLevelName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="项目频率(1每天：" prop="siteName">
                <el-input v-model="form.itemFrequency" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="操作类型(数据字典(ins_operation_type))：" prop="siteName">
                <el-input v-model="form.operationType" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="结束时间(hh:mm)：" prop="siteName">
                <el-input v-model="form.endTime" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="星期几(频率每周)：" prop="siteName">
                <el-input v-model="form.weekNum" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="几号(频率每月)：" prop="siteName">
                <el-input v-model="form.dayNum" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    getList () {
	  var that = this;
    that.loading = true
	  that.$http.post("/careNursingPlanSetting/list", that.queryInfo).then(function (response) {
    ...
    handleSave () {
	    var that = this;
	  that.$http.post("/careNursingPlanSetting/save", that.form).then(function (response) {
		  if (response.data.code == 200) {
			  that.$notify.success({
				title: "提示",
				message: "保存成功",
...
//    },
    ...
    async handleDelte(id) {
      ...
      if (confirmResult === "confirm") {
           var that = this;
        that.$http.post("/careNursingPlanSetting/delete" ,{"id":id}).then(function (response) {
			if(response.data.code == 200){
			 that.$notify.success({
				title: "提示",
				message: "删除成功",
