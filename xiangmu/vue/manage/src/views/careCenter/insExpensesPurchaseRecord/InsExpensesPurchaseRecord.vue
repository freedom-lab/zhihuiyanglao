    ...
    <div>
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%" :height="height">
        ...
        <el-table-column label="老人姓名" align="center" show-overflow-tooltip>
          ...
          <el-table-column label="消费时间" align="center" show-overflow-tooltip>
          ...
          <el-table-column label="费用类型" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.articleType }}</template>
          </el-table-column>
          <el-table-column label="费用金额" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.articlePrice }}</template>
          </el-table-column>
    ...
    <el-dialog :title="(labelType=='add'?'新增':'编辑')" :visible.sync="showDialog" width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="10">
            ...
            <el-col :span="12">
              <el-form-item label="消费时间：" prop="siteName">
                <el-input v-model="form.buyTime" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="费用名称：" prop="siteName">
                <el-input v-model="form.articleName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="费用类型(数据字典(ins_article_type))：" prop="siteName">
                <el-input v-model="form.articleType" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="费用金额：" prop="siteName">
                <el-input v-model="form.articlePrice" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="结算状态(1挂账：" prop="siteName">
            ...
            <el-col :span="12">
              <el-form-item label="费用说明：" prop="siteName">
