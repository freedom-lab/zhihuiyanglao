    ...
    <div>
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%" :height="height">
        <el-table-column label="序号" type="index" width="50" align="center"></el-table-column>
          ...
          <el-table-column label="组织编码" align="center" show-overflow-tooltip>
          ...
          <el-table-column label="别名" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.organAlias }}</template>
          </el-table-column>
          <el-table-column label="组织类型" align="center" show-overflow-tooltip>
          ...
          <el-table-column label="父级组织编码" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.parentCode }}</template>
          </el-table-column>
          <el-table-column label="扬力组织负责人id" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.userCode }}</template>
          </el-table-column>
          <el-table-column label="扬力组织负责人姓名" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.userName }}</template>
          </el-table-column>
          <el-table-column label="扬力执行负责人" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.executeUserName }}</template>
          </el-table-column>
          <el-table-column label="组织等级" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.organLevel }}</template>
          </el-table-column>
          <el-table-column label="组织事业群" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.organGroup }}</template>
          </el-table-column>
          <el-table-column label="扬力部门状态" align="center" show-overflow-tooltip>
    ...
    <el-dialog :title="(labelType=='add'?'新增':'编辑')" :visible.sync="showDialog" width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="10">
            ...
            <el-col :span="12">
              <el-form-item label="组织编码：" prop="siteName">
                <el-input v-model="form.organCode" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="组织名称：" prop="siteName">
                <el-input v-model="form.organName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="别名：" prop="siteName">
                <el-input v-model="form.organAlias" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="组织类型：" prop="siteName">
                <el-input v-model="form.organType" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="描述：" prop="siteName">
            ...
            <el-col :span="12">
              <el-form-item label="创建人：" prop="siteName">
                <el-input v-model="form.creator" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="创建人：" prop="siteName">
                <el-input v-model="form.updator" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="创建时间：" prop="siteName">
            ...
            <el-col :span="12">
              <el-form-item label="父级组织编码：" prop="siteName">
                <el-input v-model="form.parentCode" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="扬力组织负责人id：" prop="siteName">
                <el-input v-model="form.userCode" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="扬力组织负责人姓名：" prop="siteName">
                <el-input v-model="form.userName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="扬力执行负责人：" prop="siteName">
                <el-input v-model="form.executeUserName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="组织等级：" prop="siteName">
                <el-input v-model="form.organLevel" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="组织事业群：" prop="siteName">
                <el-input v-model="form.organGroup" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="扬力部门状态：" prop="siteName">
...
export default {
  ...
  methods: {
    ...
    getList () {
	  var that = this;
    that.loading = true
	  that.$http.post("/organ/list", that.queryInfo).then(function (response) {
    ...
    handleSave () {
	    var that = this;
	  that.$http.post("/organ/save", that.form).then(function (response) {
		  if (response.data.code == 200) {
			  that.$notify.success({
				title: "提示",
				message: "保存成功",
...
//    },
    ...
    async handleDelte(id) {
      ...
      if (confirmResult === "confirm") {
           var that = this;
        that.$http.post("/organ/delete" ,{"id":id}).then(function (response) {
			if(response.data.code == 200){
			 that.$notify.success({
				title: "提示",
				message: "删除成功",
