<template>
  <div class="page-outer">
    <div class="page-container">
      <div ref="search_d">
        <span style="font-size:18px;font-weight:bold">预约参观统计</span>
      </div>
  ...
  methods: {
    ...
    initChart(sdata) {
      ...
      this.option = {
        ...
        color: ['#409eff', '#ffc152', '#28c7cc', '#ff7a6e', '#9c6bde' ],
        legend: {
          // orient: 'vertical',
          right: '5%',
          top: '10%',
    ...
    getStats() {
      ...
      that.$http.post("/deandashboard/visitStateStatistics", params).then( (response)=> {
        if (response.data.code == 200) {
          that.loading = false
