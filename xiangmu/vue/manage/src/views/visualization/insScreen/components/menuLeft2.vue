    ...
    <div class="page">
      ...
      <div class="page-left">
        <div class="oldBox">
          ...
          <div class="oneCon">
            <div class="day">
              <div class="li1"> 今日在院老人数 <span></span></div>
              <div class="li2">
                <div class="h3"></div>
                <div class="p">核定床位数</div>
              </div>
              <div class="li3">
                <div class="h3">%</div>
                <div class="p">入住率</div>
        ...
        <div class="oldBox">
          ...
          <div class="twoCon">
            <div class="ul">
              <div class="li li1">
                <div class="h3"></div>
                <div class="p">员工总数</div>
              </div>
              <div class="li li2">
                <div class="h3"></div>
                <div class="p">护理人员</div>
              </div>
              <div class="li li3">
                <div class="h3">%</div>
                <div class="p">护理员持证率</div>
              </div>
            </div>
            <div class="title">员工岗位统计</div>
            <div>
              <div class="content">
            ...
            <div class="title">护理员证书等级统计</div>
            <div>
              <div class="content">
                <div id="live-box" style="width: 450px; height: 180px;"></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="tit">
            ...
            <div role="radiogroup" class="el-radio-group radioA">
              <label role="radio" aria-checked="true" tabindex="0" class="el-radio-button el-radio-button--small is-active">
                <input type="radio" tabindex="-1" autocomplete="off" class="el-radio-button__orig-radio" value="本周">
                <span class="el-radio-button__inner">本周</span>
              </label>
              <label role="radio" tabindex="-1" class="el-radio-button el-radio-button--small">
                <input type="radio" tabindex="-1" autocomplete="off" class="el-radio-button__orig-radio" value="本月">
                <span class="el-radio-button__inner">本月</span>
              </label>
              <label role="radio" tabindex="-1" class="el-radio-button el-radio-button--small">
                <input type="radio" tabindex="-1" autocomplete="off" class="el-radio-button__orig-radio" value="本年">
                <span class="el-radio-button__inner">本年</span>
              </label>
            </div>
          </div>
          <div class="fourCon">
            <div>
              <div class="content">
                <!-- 折线图容器id保留不变 -->
                <div id="region-box" style="width: 100%; height: 240px;"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="page-right">
        <div class="oldBox">
          ...
          <div class="serveCon">
            <div class="li li1">
              <div class="h3">应收费用</div>
              <div class="p"></div>
            </div>
            <div class="li li2">
              <div class="h3">实收金额</div>
              <div class="p"></div>
            </div>
            <div class="li li3">
              <div class="h3">欠费金额</div>
              <div class="p"></div>
            </div>
          </div>
        </div>
        ...
        <div class="oldBox">
          ...
          <div class="sexCon">
            <div>
              <div class="content">
                <div id="grade-box" style="width: 100%; height: 250px;"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="oldBox">
          ...
          <div class="fireCon">
            <div class="li">
              ...
              <div class="con">
                <h4>本月物品订单</h4>
                <p><span class="count m-t-10">2017</span></p>
              </div>
            </div>
            <div class="li">
              <img :src="shiico2">
...
export default {
  ...
  data() {
    return {
        ...
        sjico1: 'https://zhky.ahjykjxx.com/resources/visualization/insScreen/img/sj-ico1.png',
        sjico2: 'https://zhky.ahjykjxx.com/resources/visualization/insScreen/img/sj-ico2.png',
        sjico3: 'https://zhky.ahjykjxx.com/resources/visualization/insScreen/img/sj-ico3.png',
        sjico4: 'https://zhky.ahjykjxx.com/resources/visualization/insScreen/img/sj-ico4.png',
        ...
        nomapimg4: 'https://zhky.ahjykjxx.com/resources/visualization/insScreen/img/nomap-img4.png',
        shiico1: 'https://zhky.ahjykjxx.com/resources/visualization/insScreen/img/shi-ico1.png',
        shiico2: 'https://zhky.ahjykjxx.com/resources/visualization/insScreen/img/shi-ico2.png',
        shiico3: 'https://zhky.ahjykjxx.com/resources/visualization/insScreen/img/shi-ico3.png',
        shiico4: 'https://zhky.ahjykjxx.com/resources/visualization/insScreen/img/shi-ico4.png',
        shiico5: 'https://zhky.ahjykjxx.com/resources/visualization/insScreen/img/shi-ico5.png',
        shiico6: 'https://zhky.ahjykjxx.com/resources/visualization/insScreen/img/shi-ico6.png',
...
.oneCon .day {
    ...
    width: 400px;
    height: 110px;
    background-image: url('https://zhky.ahjykjxx.com/resources/visualization/insScreen/img/one-ico.png');
    background-size: 100% 100%
}
...
.oneCon .year .ul {
    background: rgba(0,28,57,.1);
    border-top: 1px solid #0c3d5d;
    padding: 10px 0
}

.oneCon .year .ul .li,.oneCon .year .ul {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    -webkit-box-align: center;
...
.oneCon .year .ul .li img {
    width: 31px;
    height: 32px;
    margin: 0 8px
}

.oneCon .year .ul .li .con .h3 {
    font-size: 16px;
    color: #fff
}

.oneCon .year .ul .li .con .p {
    margin-top: 5px;
    font-size: 18px;
    color: #fff
}
...
.fireCon .li .con h4 {
    ...
    line-height: 26px;
    padding-left: 10px;
    background: -webkit-gradient(linear,left top,right top,from(rgba(128,197,240,.51)),to(rgba(128,197,240,0)));
    background: linear-gradient(90deg,rgba(128,197,240,.51),rgba(128,197,240,0));
    margin-top: 15px;
    font-size: 14px;
    color: #d9f3ff;
    border-left: 2px solid #80c5f0
}
