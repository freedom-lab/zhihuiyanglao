  ...
  <div class="tab-box">
    ...
    <div class="table-box">
      ...
      >
        ...
        <el-table-column label="原护理等级" align="center" min-width="120">
          <template slot-scope="scope">{{ scope.row.oldNursingLevelName }}</template>
        </el-table-column>
        <el-table-column label="原护理费（元）" align="center" min-width="120">
          <template slot-scope="scope">{{ scope.row.oldNursingPrice }}</template>
        </el-table-column>
        <el-table-column label="新护理等级" align="center" min-width="120">
          <template slot-scope="scope">{{ scope.row.newNursingLevelName }}</template>
        </el-table-column>
        <el-table-column label="新护理费（元）" align="center" min-width="120">
          <template slot-scope="scope">{{ scope.row.newNursingPrice }}</template>
        </el-table-column>
  ...
  methods: {
    ...
    handleSave() {
      ...
      that.$refs.form.validate((valid) => {
        ...
        that.$http.post("/insNursingChangeNursingRecord/save", that.form).then( (response)=> {
          if (response.data.code == 200) {
            that.$notify.success({
              title: "提示",
              message: "保存成功",
