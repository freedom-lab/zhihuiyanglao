  ...
  <div style="padding:16px">
    ...
    <div ref="search_d">
      <el-row type="flex" class="row-bg" justify="space-around">
        <el-col :span="15">
          <span style="font-size:18px;font-weight:bold">能力评估任务</span>
        </el-col>
        <el-col :span="15">
      ...
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%"
        ...
        <el-table-column label="操作" width="180" align="center" fixed="right">
          <template slot-scope="scope">
            ...
            <!-- <el-button type="text" @click="lookEvaluate(scope.row)" size="small" style="padding: 0;margin-left: 15px;">查看</el-button> -->
    ...
    <AssessmentFlowDialog :visible.sync="assessmentFlowVisible"
      :initialElder="flowInitialElder" :templateType="1" @completed="getList"/>
