    ...
    <div>
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%" :height="height">
        <el-table-column label="序号" type="index" width="50" align="center"></el-table-column>
          ...
          <el-table-column label="睡眠时间(小时)" align="center" show-overflow-tooltip>
          ...
          <el-table-column label="胸部呼吸音" align="center" show-overflow-tooltip>
          ...
          <el-table-column label="四肢皮肤水肿" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.armsSkin }}</template>
          </el-table-column>
          <el-table-column label="四肢皮肤描述" align="center" show-overflow-tooltip>
          ...
          <el-table-column label="肛门生殖器" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.anusStatus }}</template>
          </el-table-column>
          <el-table-column label="乳房生殖器" align="center" show-overflow-tooltip>
          ...
          <el-table-column label="体检总评价" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.checkResult }}</template>
          </el-table-column>
          <el-table-column label="是否为入院体检" align="center" show-overflow-tooltip>
