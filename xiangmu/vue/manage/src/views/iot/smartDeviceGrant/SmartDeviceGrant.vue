    ...
    <div>
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%" :height="height">
        <el-table-column label="序号" type="index" width="50" align="center"></el-table-column>
          ...
          <el-table-column label="设备电量百分比" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.battery }}</template>
          </el-table-column>
          <el-table-column label="同步状态" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.synStatus }}</template>
          </el-table-column>
          <el-table-column label="发放类型" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.grantType }}</template>
          </el-table-column>
          ...
          <el-table-column label="床位名称" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.bedName }}</template>
          </el-table-column>
          <el-table-column label="发放位置" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.grantLocation }}</template>
          </el-table-column>
          <el-table-column label="设备照片" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.img }}</template>
          </el-table-column>
          <el-table-column label="设备参数" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.param }}</template>
          </el-table-column>
          <el-table-column label="设备版本号" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.deviceVersion }}</template>
          </el-table-column>
...
<!-- 
            ...
            <el-col :span="12">
              <el-form-item label="机构编号：" prop="siteName">
                <el-input v-model="form.institutionCode" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="在线状态：" prop="siteName">
                <el-input v-model="form.isOnline" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="设备电量百分比：" prop="siteName">
                <el-input v-model="form.battery" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="同步状态：" prop="siteName">
                <el-input v-model="form.synStatus" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="发放类型：" prop="siteName">
                <el-input v-model="form.grantType" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="床位名称：" prop="siteName">
                <el-input v-model="form.bedName" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="发放位置：" prop="siteName">
                <el-input v-model="form.grantLocation" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="设备照片：" prop="siteName">
                <el-input v-model="form.img" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="设备参数：" prop="siteName">
                <el-input v-model="form.param" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="设备版本号：" prop="siteName">
                <el-input v-model="form.deviceVersion" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="区域编码：" prop="siteName">
                <el-input v-model="form.areaCode" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="区域名称：" prop="siteName">
            ...
            <el-col :span="12">
              <el-form-item label="数据同步状态：" prop="siteName">
                <el-input v-model="form.gspState" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
        </el-row>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    getList () {
	  var that = this;
    that.loading = true
	  that.$http.post("/smartDeviceGrant/list", that.queryInfo).then(function (response) {
    ...
    handleSave () {
	    var that = this;
	  that.$http.post("/smartDeviceGrant/save", that.form).then(function (response) {
		  if (response.data.code == 200) {
			  that.$notify.success({
				title: "提示",
				message: "保存成功",
...
//    },
    ...
    async handleDelte(id) {
      ...
      if (confirmResult === "confirm") {
           var that = this;
        that.$http.post("/smartDeviceGrant/delete" ,{"id":id}).then(function (response) {
			if(response.data.code == 200){
			 that.$notify.success({
				title: "提示",
				message: "删除成功",
