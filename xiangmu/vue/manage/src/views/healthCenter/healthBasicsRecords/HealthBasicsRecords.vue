    ...
    <div>
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%" :height="height">
        <el-table-column label="序号" type="index" width="50" align="center"></el-table-column>
          ...
          <el-table-column label="腰围" align="center" show-overflow-tooltip>
          ...
          <el-table-column label="脂肪含量" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.fatContent }}</template>
          </el-table-column>
          <el-table-column label="体质指数" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.bmi }}</template>
          </el-table-column>
          <el-table-column label="基础代谢值" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.bmr }}</template>
          </el-table-column>
          <el-table-column label="脂肪率" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.pbf }}</template>
          </el-table-column>
          <el-table-column label="水分率" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.water }}</template>
          </el-table-column>
          <el-table-column label="骨骼量" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.bone }}</template>
          </el-table-column>
          <el-table-column label="肌肉量" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.muscle }}</template>
          </el-table-column>
          <el-table-column label="体质指数判断结果" align="center" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.bmiResult }}</template>
          </el-table-column>
          <el-table-column label="体型类型" align="center" show-overflow-tooltip>
    ...
    <el-dialog :title="(labelType=='add'?'新增':'编辑')" :visible.sync="showDialog" width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="10">
            ...
            <el-col :span="12">
              <el-form-item label="腰围：" prop="siteName">
            ...
            <el-col :span="12">
              <el-form-item label="脂肪含量：" prop="siteName">
                <el-input v-model="form.fatContent" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="体质指数：" prop="siteName">
                <el-input v-model="form.bmi" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="基础代谢值：" prop="siteName">
                <el-input v-model="form.bmr" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="脂肪率：" prop="siteName">
                <el-input v-model="form.pbf" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="水分率：" prop="siteName">
                <el-input v-model="form.water" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="骨骼量：" prop="siteName">
                <el-input v-model="form.bone" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="肌肉量：" prop="siteName">
                <el-input v-model="form.muscle" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="体质指数判断结果：" prop="siteName">
                <el-input v-model="form.bmiResult" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="体型类型：" prop="siteName">
                <el-input v-model="form.bt" placeholder="请输入名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    getList () {
	  var that = this;
    that.loading = true
	  that.$http.post("/healthBasicsRecords/list", that.queryInfo).then(function (response) {
    ...
    handleSave () {
	    var that = this;
	  that.$http.post("/healthBasicsRecords/save", that.form).then(function (response) {
		  if (response.data.code == 200) {
			  that.$notify.success({
				title: "提示",
				message: "保存成功",
...
//    },
    ...
    async handleDelte(id) {
      ...
      if (confirmResult === "confirm") {
           var that = this;
        that.$http.post("/healthBasicsRecords/delete" ,{"id":id}).then(function (response) {
			if(response.data.code == 200){
			 that.$notify.success({
				title: "提示",
				message: "删除成功",
