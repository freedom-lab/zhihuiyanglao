  ...
  <div class="tab-box">
    ...
    <div class="table-box">
      ...
      >
        ...
        <el-table-column label="身高(厘米)" align="center" width="110" show-overflow-tooltip>
          <template slot-scope="scope">{{ scope.row.height }}</template>
        </el-table-column>
        <el-table-column label="体重(千克)" align="center" width="110" show-overflow-tooltip>
        ...
        <el-table-column label="基础代谢值" align="center" width="110" show-overflow-tooltip>
        ...
        <el-table-column label="体质指数判断结果" align="center" width="140" show-overflow-tooltip>
          <template slot-scope="scope">{{ scope.row.bmiResult | bmiResultFormat }}</template>
        </el-table-column>
        <el-table-column label="体型类型" align="center" show-overflow-tooltip>
          <template slot-scope="scope">{{ scope.row.bt | btFormat }}</template>
        </el-table-column>
        <el-table-column label="分析结果" align="center" show-overflow-tooltip>
          <template slot-scope="scope">{{ scope.row.analysisResult | analysisResultFormat }}</template>
        </el-table-column>
  ...
  methods: {
    ...
    handleSave() {
      ...
      that.$refs.form.validate((valid) => {
        ...
        that.$http.post("/healthBasicsRecords/save", that.form).then( (response)=> {
          if (response.data.code == 200) {
            that.$notify.success({
              title: "提示",
              message: "保存成功",
