  ...
  <div class="tab-box">
    ...
    <div class="table-box">
      ...
      >
        ...
        <el-table-column label="心电图" align="center" show-overflow-tooltip>
          <template slot-scope="scope">
            <div class="imgAudit">
              <el-image fit="scale-down" :preview-src-list="[scope.row.picData]" :src="scope.row.picData">
  ...
  methods: {
    ...
    handleSave() {
      ...
      that.$refs.form.validate((valid) => {
        ...
        that.$http.post("/healthEcgRecords/save", that.form).then( (response)=> {
          if (response.data.code == 200) {
            that.$notify.success({
              title: "提示",
              message: "保存成功",
