  ...
  <div class="tab-box">
    ...
    <div class="table-box">
      ...
      >
        ...
        <el-table-column label="测量设备" align="center" min-width="80">
          <template slot-scope="scope">{{ scope.row.gaugeType }}</template>
        </el-table-column>
        <el-table-column label="测量条件" align="center" min-width="120">
          <template slot-scope="scope">{{ scope.row.conditions | conditionsFormat }}</template>
        </el-table-column>
        <el-table-column label="脉搏率(次/分)" align="center" min-width="120">
          <template slot-scope="scope">{{ scope.row.pulseRate }}</template>
        </el-table-column>
        <el-table-column label="收缩压(高压)" align="center" min-width="120">
          <template slot-scope="scope">{{ scope.row.systolicPressure }}</template>
        </el-table-column>
        <el-table-column label="舒张压(低压)" align="center" min-width="100">
        ...
        <el-table-column label="收缩压(高压)分析结果" align="center" show-overflow-tooltip>
          <template slot-scope="scope">{{ scope.row.systolicPressureResult | pressureResultFormat }}</template>
        </el-table-column>
        <el-table-column label="收缩压(低压)分析结果" align="center" show-overflow-tooltip>
          <template slot-scope="scope">{{ scope.row.diastolicPressureResult | pressureResultFormat }}</template>
        </el-table-column>
  ...
  methods: {
    ...
    handleSave() {
      ...
      that.$refs.form.validate((valid) => {
        ...
        that.$http.post("/healthBloodPressure/save", that.form).then( (response)=> {
          if (response.data.code == 200) {
            that.$notify.success({
              title: "提示",
              message: "保存成功",
