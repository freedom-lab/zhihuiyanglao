  ...
  <div style="padding:16px">
    ...
    <div ref="search_d">
      <el-row type="flex" class="row-bg" justify="space-around">
        <el-col :span="15">
          <span style="font-size:18px;font-weight:bold">试住老人管理</span>
        </el-col>
        <el-col :span="10">
    ...
    <div class="table-box">
      <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%"
        ...
        <!-- 入住流程 & 状态 -->
        <el-table-column label="入住步骤" align="center" min-width="90">
          <template slot-scope="scope">{{ scope.row.checkStep }}</template>
        </el-table-column>
        <!-- 计划入住日期 -->
        ...
        <!-- 实际入住日期 -->
        <el-table-column label="试住入住日期" align="center" min-width="120">
          <template slot-scope="scope">
        ...
        <el-main class="dialogMain">
          <el-form ref="form" :model="form" :rules="rules" label-width="120px" disabled>
            <el-row :gutter="10">
              ...
              <!-- 入住流程 -->
              <el-col :span="12">
                <el-form-item label="入住步骤" prop="checkStep">
                  <el-input v-model="form.checkStep" placeholder="请输入入住步骤"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
              ...
              <el-col :span="12">
                <el-form-item label="试住入住日期" prop="checkDate">
              ...
              <el-col :span="12">
                <el-form-item label="入住状态" prop="checkState">
                  <el-input v-model="form.checkState" placeholder="请输入入住状态"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
