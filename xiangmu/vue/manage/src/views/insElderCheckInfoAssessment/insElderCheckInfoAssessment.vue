    ...
    <div style="padding:16px">
        ...
        <div ref="search_d">
            <el-row type="flex" class="row-bg" justify="space-around">
                <el-col :span="15">
                    <span style="font-size:18px;font-weight:bold">入住评估</span>
                </el-col>
                <el-col :span="10">
        ...
        <div class="table-box">
            <el-table border ref="table" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%"
                ...
                <el-table-column label="操作" width="150" align="center" fixed="right">
                    <template slot-scope="scope">
                        <el-button v-if="scope.row.checkStep <= 2" type="text" @click="evaluate(scope.row)" size="small"
                            style="padding: 0;">去评估</el-button>
                        <el-button type="text" @click="edit(scope.row)" size="small" style="padding: 0;">编辑</el-button>
                        <el-button v-if="scope.row.checkStep > 2" type="text" @click="lookEvaluate(scope.row)"
                            size="small" style="padding: 0;">查看评估</el-button>
                        ...
                        <el-row :gutter="10">
                            ...
                            <el-col :span="12">
                                <el-form-item label="计划入住日期" prop="planDate">
                                    <el-date-picker v-model="form.planDate" type="date" placeholder="请选择计划入住日期"
                                        style="width:100%"></el-date-picker>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="实际入住日期" prop="checkDate">
                                    <el-date-picker v-model="form.checkDate" type="date" placeholder="请选择实际入住日期"
                                        style="width:100%"></el-date-picker>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="试住结束日期" prop="tryingEndDate">
                                    <el-date-picker v-model="form.tryingEndDate" type="date" placeholder="请选择试住结束日期"
                                        style="width:100%"></el-date-picker>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                            ...
                            <el-col :span="12">
                                <el-form-item label="退住时间" prop="retreatTime">
                                    <el-date-picker v-model="form.retreatTime" type="date" placeholder="请选择退住时间"
                                        style="width:100%"></el-date-picker>
                                </el-form-item>
                            </el-col>
