## 项目基础模版描述
>该项目主要是后台管理系统，基于快速开发的准则，搭配[城投康养家管理平台]代码机器人使用
>此项目模版基于[城投康养家管理平台]代码机器人开发
>代码机器人的功能
  1.生成后端的增删改查
  2.生成前端的增删改查
>代码机器人版本历程
...
### 集成代码机器人代码
>基础模块代码可以通过 [预览]http://srobot.pluss.cn 生成基础的增删改查
>代码生成后，在vue的目录下面rooter.js 把里面的内容粘贴到项目rooter.js里面来
>代码生成后，在vue的目录下面功能模块的代码是按照文件夹存放的，直接把文件夹粘贴到项目views目录下面
>在菜单管理配置好菜单，和对应的权限即可访问生成的页面


##### [接口API]
> 对应项目部署的服务器ip或者域名(./api/doc.html)
  e.g. http://127.0.0.1:8002/api/doc.html
...
> 初始化模版自带一套权限管理，满足角色、菜单、用户等相关权限管理
