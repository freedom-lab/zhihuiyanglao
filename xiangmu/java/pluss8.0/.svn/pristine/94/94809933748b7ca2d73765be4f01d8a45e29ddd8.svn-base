...
@TableName("tb_jiangyukeji_health_blood_oxygen")
@Data
public class HealthBloodOxygen implements Serializable, Cloneable {
    ...
    /***** 血氧饱和度 ***/
    @TableField(value = "oxygen_saturation")
    ...
    /***** 体温 ***/
    @TableField(value = "body_temperature")
