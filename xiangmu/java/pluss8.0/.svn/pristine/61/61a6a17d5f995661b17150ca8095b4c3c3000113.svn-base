package cn.pluss.platform.service.insExpensesImprestUsesRecord;
...
public interface InsExpensesImprestUsesRecordService extends IService<InsExpensesImprestUsesRecord> {
