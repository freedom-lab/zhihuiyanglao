package cn.pluss.platform.service.healthInterventionsTemple;
...
public interface HealthInterventionsTempleService extends IService<HealthInterventionsTemple> {
