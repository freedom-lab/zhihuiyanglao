package cn.pluss.platform.service.insNursingRoomExecutionRecord;
...
public interface InsNursingRoomExecutionRecordService extends IService<InsNursingRoomExecutionRecord> {
