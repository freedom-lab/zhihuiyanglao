...
@TableName("tb_jiangyukeji_health_blood_fat")
@Data
public class HealthBloodFat implements Serializable, Cloneable {
    ...
    /***** 高密度脂蛋白胆固醇含量 ***/
    @TableField(value = "hdlchol")
    private Double hdlchol;

    /***** 甘油三酯含量 ***/
    @TableField(value = "trig")
    private Double trig;

    /***** 低密度脂蛋白胆固醇含量 ***/
    @TableField(value = "calcldl")
    private Double calcldl;

    /***** 总胆固醇和高密度胆固醇的比值 ***/
    @TableField(value = "tc_hdl")
    private Double tcHdl;
