package cn.pluss.platform.service.healthTemperatureRecords;
...
public interface HealthTemperatureRecordsService extends IService<HealthTemperatureRecords> {
    ...
    */
     ...
     */
    Map<String, Object> monitorBodyTemperature(HealthTemperatureRecords queryParam);
 }
