...
@TableName("tb_jiangyukeji_health_hemoglobin_records")
@Data
public class HealthHemoglobinRecords implements Serializable, Cloneable {
    ...
    /***** 红细胞比容(%) ***/
    @TableField(value = "hct")
    private Double hct;

    /***** 分析结果(0正常，1轻度偏低（轻度贫血），2中度偏低（中度贫血），3严重偏低（严重贫血）) ***/
