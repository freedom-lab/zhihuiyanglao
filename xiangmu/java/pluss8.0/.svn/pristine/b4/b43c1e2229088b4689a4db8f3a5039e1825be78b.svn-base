...
@TableName("tb_jiangyukeji_health_blood_ketone")
@Data
public class HealthBloodKetone implements Serializable, Cloneable {
    ...
    /***** 酮体(mmol/L) ***/
    @TableField(value = "hCY")
    private float hCY;

    /***** 酮体状态 ***/
    @TableField(value = "hCYState")
    private Integer hCYState;
