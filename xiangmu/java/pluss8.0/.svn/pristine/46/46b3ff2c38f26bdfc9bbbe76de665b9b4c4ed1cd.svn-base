package cn.pluss.platform.service.insLogisticsMaterialFrmloss;
...
public interface InsLogisticsMaterialFrmlossService extends IService<InsLogisticsMaterialFrmloss> {
