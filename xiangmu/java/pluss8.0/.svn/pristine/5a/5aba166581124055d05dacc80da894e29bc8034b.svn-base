package cn.pluss.platform.service.insElderCheckInfo;
...
public interface InsElderCheckInfoService extends IService<InsElderCheckInfo> {
    ...
    */
    ...
    Object getTodayAndMonthData(HealthDto healthDto);

    Object getTodayRealTimeData();
}
