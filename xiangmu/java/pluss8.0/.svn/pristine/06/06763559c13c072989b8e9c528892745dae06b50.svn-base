package cn.pluss.platform.service.assessmentInstitutionInfo;
...
public interface AssessmentInstitutionInfoService extends IService<AssessmentInstitutionInfo> {
