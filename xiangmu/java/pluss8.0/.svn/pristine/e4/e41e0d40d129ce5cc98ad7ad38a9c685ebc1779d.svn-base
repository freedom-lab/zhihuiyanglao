package cn.pluss.platform.service.healthTongueDiagnosisReport;
...
public interface HealthTongueDiagnosisReportService extends IService<HealthTongueDiagnosisReport> {
