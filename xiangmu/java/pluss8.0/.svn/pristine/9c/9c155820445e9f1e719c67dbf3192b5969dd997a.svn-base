...
@TableName("tb_jiangyukeji_ins_office_online_class")
@Data
public class InsOfficeOnlineClass implements Serializable, Cloneable {
    ...
    /***** 课程小类（护理小类：1.饮食照料、2.清洁照料、3.排泄照料、4.用药照料 ***/
