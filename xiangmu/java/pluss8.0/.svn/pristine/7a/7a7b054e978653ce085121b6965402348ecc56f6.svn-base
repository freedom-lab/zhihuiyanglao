...
@TableName("tb_jiangyukeji_health_blood_pressure")
@Data
public class HealthBloodPressure implements Serializable, Cloneable {
    ...
    /***** 收缩压(高压)分析结果(0过低 ***/
    @TableField(value = "systolic_pressure_result")
    private String systolicPressureResult;

    /***** 收缩压(低压)分析结果(0过低 ***/
    @TableField(value = "diastolic_pressure_result")
