package cn.pluss.platform.service.insSecurityDangersCheckDetail;
...
public interface InsSecurityDangersCheckDetailService extends IService<InsSecurityDangersCheckDetail> {
