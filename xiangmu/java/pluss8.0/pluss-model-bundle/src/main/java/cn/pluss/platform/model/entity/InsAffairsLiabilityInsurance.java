...
@TableName("tb_jiangyukeji_ins_affairs_liability_insurance")
@Data
public class InsAffairsLiabilityInsurance implements Serializable, Cloneable {
    ...
    /***** 投保公司 ***/
    @TableField(value = "insurance_corp")
