...
@TableName("tb_jiangyukeji_ins_staff_dimission_record")
@Data
public class InsStaffDimissionRecord implements Serializable, Cloneable {
    ...
    /***** 离职类型(数据字典(ins_dimission_type)) ***/
    @TableField(value = "dimission_type")
    private String dimissionType;

    /***** 离职原因 ***/
    @TableField(value = "dimission_memo")
