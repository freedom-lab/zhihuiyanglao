...
@TableName("tb_jiangyukeji_ins_nursing_turnover_record")
@Data
public class InsNursingTurnoverRecord implements Serializable, Cloneable {
    ...
    /***** 防护用具 ***/
    @TableField(value = "protective_equipment")
    private String protectiveEquipment;

    /***** 压疮处理 ***/
    @TableField(value = "pressure_ulcer")
