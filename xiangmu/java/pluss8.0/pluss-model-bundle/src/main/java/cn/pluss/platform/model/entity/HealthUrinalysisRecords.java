...
@TableName("tb_jiangyukeji_health_urinalysis_records")
@Data
public class HealthUrinalysisRecords implements Serializable, Cloneable {
    ...
    /***** 白细胞值 ***/
    @TableField(value = "leu")
    private String leu;

    /***** 亚硝酸盐值 ***/
    @TableField(value = "nit")
    private String nit;

    /***** 尿胆原值 ***/
    @TableField(value = "ubg")
    private String ubg;
    ...
    /***** 酮体值 ***/
    @TableField(value = "ket")
    private String ket;

    /***** 胆红素值 ***/
    @TableField(value = "bil")
    private String bil;
