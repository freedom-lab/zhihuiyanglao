...
@TableName("tb_jiangyukeji_ins_expenses_change_food_record")
@Data
public class InsExpensesChangeFoodRecord implements Serializable, Cloneable {
    ...
    /***** 原餐费id ***/
    @TableField(value = "old_food_id")
    private Long oldFoodId;

    /***** 原餐费名称 ***/
    @TableField(value = "old_food_name")
    private String oldFoodName;

    /***** 原餐费价格(元) ***/
    @TableField(value = "old_food_price")
    private Double oldFoodPrice;

    /***** 新餐费id ***/
    @TableField(value = "new_food_id")
    private Long newFoodId;

    /***** 新餐费名称 ***/
    @TableField(value = "new_food_name")
    private String newFoodName;

    /***** 新餐费价格(元) ***/
    @TableField(value = "new_food_price")
