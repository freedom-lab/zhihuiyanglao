package cn.pluss.platform.service.healthUrinalysisRecords;
...
public interface HealthUrinalysisRecordsService extends IService<HealthUrinalysisRecords> {
    ...
    */
     ...
     */
    Map<String, Object> monitorUrinalysis(HealthUrinalysisRecords queryParam);
 }
